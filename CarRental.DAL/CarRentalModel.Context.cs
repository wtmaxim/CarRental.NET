...
namespace CarRental.DAL
{
    ...
    public partial class CarRentalEntities : DbContext
    {
        ...
        public virtual ObjectResult<Action> usp_Address_GetAddress(Nullable<int> idBooking)
        {
            var idBookingParameter = idBooking.HasValue ?
                new ObjectParameter("IdBooking", idBooking) :
                new ObjectParameter("IdBooking", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Action>("usp_Address_GetAddress", idBookingParameter);
        }
    
        public virtual ObjectResult<Action> usp_Address_GetAddress(Nullable<int> idBooking, MergeOption mergeOption)
        {
            var idBookingParameter = idBooking.HasValue ?
                new ObjectParameter("IdBooking", idBooking) :
                new ObjectParameter("IdBooking", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Action>("usp_Address_GetAddress", mergeOption, idBookingParameter);
        }
        ...
        public virtual ObjectResult<usp_StopOver_Insert_Result> usp_StopOver_Insert(Nullable<System.DateTime> arrivalDate, Nullable<System.DateTime> departureDate, Nullable<int> idBooking, Nullable<int> idStopOverType)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_StopOver_Insert_Result>("usp_StopOver_Insert", arrivalDateParameter, departureDateParameter, idBookingParameter, idStopOverTypeParameter);
        }
